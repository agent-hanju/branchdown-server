...
import dev.hanju.branchdown.service.StreamService.NewBranchSpec;
import dev.hanju.branchdown.service.StreamService.NewPointSpec;
import dev.hanju.branchdown.service.StreamService.ParentPointUpdate;
...
public class TreeService {
  ...
  public Tree<String> loadAllRoute(final Long streamId) {
    ...
    // childBranchNums에는 자식의 branchNum만 들어 있으므로,
    // (branchNum, depth)를 키로 만들어 부모에서 자식 Point를 빠르게 찾습니다.
