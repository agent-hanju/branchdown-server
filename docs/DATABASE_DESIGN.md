...
| ------------------- | ------------ | -------------------------------------------------- | ---------------------------------------------- |
| `stream_id`         | BIGINT       | PK, FK → streams(stream_id)                        | 소속 스트림 ID                                 |
| `seq`               | INT          | PK                                                 | 스트림 내 포인트 번호 (0부터 시작)             |
...
**Primary Key:** (`stream_id`, `seq`) - Composite Key
...
- [StreamEntity](../src/main/java/dev/hanju/branchdown/entity/StreamEntity.java)
- [BranchEntity](../src/main/java/dev/hanju/branchdown/entity/BranchEntity.java)
- [PointEntity](../src/main/java/dev/hanju/branchdown/entity/PointEntity.java)
